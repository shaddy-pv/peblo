...
Reads DATABASE_URL from the application settings (env var / .env file),
so migrations always run against the same database the application uses.

Supports async migrations via asyncio run_sync pattern.
"""
